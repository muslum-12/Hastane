          ...
          <div class="x_content">
            ...
            <form action="../netting/kullanici.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="org_name" value="<?php echo $kurumcek['org_name'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <select id="heard" class="form-control" name="org_satatus" required>
                    <option value="0" <?php echo $kurumcek['org_satatus'] == '0' ? 'selected=""' : ''; ?>>Pasif</option>
                    <option value="1" <?php if ($kurumcek['org_satatus']==1) { echo 'selected=""'; } ?>>Aktif</option>
                 </select>
               </div>
             </div>
             <input type="hidden" name="tmo_id" value="<?php echo $kurumcek['tmo_id'] ?>"> 
             <div class="ln_solid"></div>
             <div class="form-group">
              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="kurumduzenle" class="btn btn-success">Güncelle</button>
              </div>
            </div>
