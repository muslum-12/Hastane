...
$hastasor=$db->prepare("SELECT * FROM tmp_me_patient");
$hastasor->execute();
      ...
      <!-- Hasta Arama İnput İşlemi -->
          <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-8">
                   <input type="text" id="HastaGelis_Ara" name="HastaGelis_Ara" required="required" class="form-control col-md-7 col-xs-12">
                </div>
          </div>
...
$("#HastaGelis_Ara").keyup(function()
{
HastaGelisAra=$("#HastaGelis_Ara").val();
    $.ajax({
       type: "POST",
       url: "../netting/HastaGelisBul.php",
       data: {'HastaGelisAra' : HastaGelisAra},
       dataType: "text",
